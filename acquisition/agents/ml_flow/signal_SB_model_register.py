...
model_path = 'acquisition/agents/models/sb_vs_else_model.pkl'

report_path = "acquisition/agents/models/sb_vs_else_classification_report.json"
pred_path = "acquisition/agents/models/sb_vs_else_predictions.csv"
conf_matrix_path = "acquisition/agents/models/sb_vs_else_confusion_matrix.png"
model = joblib.load(model_path)
print("Signal SB Model loaded successfully.")
...
with mlflow.start_run() as run:
    mlflow.sklearn.log_model(
        sk_model=model,
        artifact_path="model",
        registered_model_name="Signal_SB_Model"
    )
...
globals_vars.set_signal_SB_model(run.info.run_id)
