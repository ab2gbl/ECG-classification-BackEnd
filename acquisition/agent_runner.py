...
from .agents.abnormal_signal_classifier_agent import AbnormalSignalClassifierAgent
import atexit
...
async def start_agents():
    ...
    if "abnormal_signal_classifier" not in AGENTS:
        AGENTS["abnormal_signal_classifier"] = AbnormalSignalClassifierAgent("abnormal_signal_classifier@localhost", "pass")
